...
public class Sculpture : MonoBehaviour {
	...
	static GraphFunction[] functions = {
		...
		Ripple, Cylinder, Wonder, Sphere, Funky, Torus, Kickass
	};
	...
	static Vector3 Wonder (float u, float v, float t) {
		Vector3 p;
	...
	static Vector3 Funky (float u, float v, float t) {
		Vector3 p;
	...
	static Vector3 Kickass (float u, float v, float t) {
		Vector3 p;
